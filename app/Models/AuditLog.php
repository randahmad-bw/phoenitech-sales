...
class AuditLog extends Model
{
    ...
    public const TYPE_ALIASES = [
        ...
        'sm_package' => SmPackage::class,
        'content_plan' => ContentPlan::class,
        'content_item' => ContentItem::class,
        'photo_session' => PhotoSession::class,
        'role' => Role::class,

        // Attendance module.
        'attendance' => Attendance::class,
        'work_schedule' => WorkSchedule::class,
        'employee_schedule' => EmployeeSchedule::class,
    ...
    public static function aliasFor(string $class): string
    {
        ...
        return $alias !== false ? $alias : Str::snake(class_basename($class));
    }
