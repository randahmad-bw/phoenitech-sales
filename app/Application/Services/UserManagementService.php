...
class UserManagementService
{
    ...
    {
        $query = User::with(['roles', 'employee:id,user_id,name,department'])->withCount('roles');
         ...
         *
         * Every employee has a login, but a few logins belong to no employee —
         * the owner account and the technical one. They are the reason the team
         * screen needs a second, smaller section: they are real accounts that
         * would otherwise be invisible on a screen listing people.
         */
        if (! empty($filters['without_employee'])) {
